            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                    ...
                    @else
                    <i class="fas fa-plus-square"></i> Add Vision
                    @endif
                </h3>
                
                <a href="{{ route('visions.index') }}" class="btn btn-success btn-sm float-right"><i class="fas fa-list"></i> Vision List</a>
              
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ (@$editData) ? route('visions.update', $editData->id) : route('visions.store') }}" method="post" id="myForm" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-2">
                        <img src="{{ (@$editData->image) ? asset('images/visions/'.@$editData->image) : asset('images/default/no.jpg') }}" id="showImage" style="width: 100px; height: 100px; border: 1px solid #999; padding: 2px;" alt="">
                      </div>
                    </div>
