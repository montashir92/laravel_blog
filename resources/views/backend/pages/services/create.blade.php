          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('services.index') }}" class="btn btn-success btn-sm float-right"><i class="fas fa-list"></i> News Service</a>
              
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ (@$editData) ? route('service.update', $editData->id) : route('service.store') }}" method="post" id="myForm">
                  @csrf
